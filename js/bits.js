...
function encodeTrie(words)
{
    ...
    outputStr += '    "directory": "' + directory.getData() + '",\n';
    
    outputStr += '    "trie": "' + trieData + '"\n';
    outputStr += "}\n";

    // console.log(outputStr);

    console.log("Encoded " + words.join("\r\n").length + 
    " bytes to " + outputStr.length + " bytes.")
...
class SuccinctTrieDictionary {
    constructor(words) {
        this.data = encodeTrie(words);
        this.dictionary = new FrozenTrie(this.data.trie, this.data.directory, this.data.nodeCount);
    }
